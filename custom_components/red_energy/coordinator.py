...
class RedEnergyDataCoordinator(DataUpdateCoordinator):
    ...
    # @PerformanceMonitor.time_operation
    @PerformanceMonitor.create_timer_decorator("async_update_data")
    ...
    # @PerformanceMonitor.time_operation
    @PerformanceMonitor.create_timer_decorator("bulk_update_data")
    ...
    # @PerformanceMonitor.time_operation
    @PerformanceMonitor.create_timer_decorator("fetch_property_usage")
